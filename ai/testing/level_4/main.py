...
async def brain(request: Request):
    ...
    #     if aimTurret(my_tank, my_tank.my_position(),my_tank.enemy_position()):
    #         if shooting: my_tank.fire()
    # else:
    #     aimTurret(my_tank, my_tank.my_position(),target)
    # if my_tank.enemy_position():
    #     target = my_tank.enemy_position()
